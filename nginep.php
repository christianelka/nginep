...
echo "\e[96m-------------------------------------------------\n";
echo "\e[96m|           RE CODE & FIXED by CHRISTO          |\n";
echo "\e[96m|            KOMUNITAS TUMBUH BERSAMA           |\n";
echo "\e[96m|   SCRIPT OYO AUTO REGIST + SUPPORT NOMOR US   |\n";
echo "\e[96m-------------------------------------------------\n";
echo "\n";
echo "\e[92m[+] Input Nomor HP (Tidak perlu dikasih 1): ";
...
echo "\e[92m[+] Enter OTP: ";
$otp = trim(fgets(STDIN)); 
echo "\e[92m[+] Enter Refferal Code: ";
...
echo $json->phone."\e[92m[+] Berhasil mendaftar OYO";
